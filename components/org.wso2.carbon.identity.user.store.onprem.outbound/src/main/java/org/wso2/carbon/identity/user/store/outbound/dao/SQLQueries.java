...
public class SQLQueries {
    ...
    public static final String ACCESS_TOKEN_INSERT = "INSERT INTO UM_ACCESS_TOKEN(UM_TOKEN,UM_STATUS,UM_TENANT," +
            "UM_DOMAIN)VALUES(?,?,?,?)";
    public static final String ACCESS_TOKEN_DELETE = "DELETE FROM UM_ACCESS_TOKEN WHERE UM_DOMAIN= ? ";
    public static final String NEXT_SERVER_NODE_GET = "SELECT A.UM_SERVER_NODE FROM UM_AGENT_CONNECTIONS " +
            ...
            "A.UM_LASTUPDATEDATE;";
    public static final String AGENT_CONNECTIONS_GET = "SELECT C.UM_NODE, C.UM_STATUS FROM UM_ACCESS_TOKEN A, " +
            "UM_AGENT_CONNECTIONS C WHERE A.UM_DOMAIN=? AND A.UM_TOKEN = C.UM_ACCESS_TOKEN ORDER BY C.UM_NODE;";
    public static final String AGENT_CONNECTIONS_DELETE_BY_DOMAIN = "DELETE FROM UM_AGENT_CONNECTIONS WHERE " +
            "UM_ACCESS_TOKEN IN (SELECT A.UM_TOKEN FROM UM_ACCESS_TOKEN A WHERE A.UM_DOMAIN=?);";
